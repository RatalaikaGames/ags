...
protected:
    ...
    template<bool has_alpha, bool opaque, bool usingLinearFiltering> void BitmapToVideoMemFast(const Bitmap *bitmap, const TextureTile *tile, const VideoMemDDB *target, char *dst_ptr, const int dst_pitch);
